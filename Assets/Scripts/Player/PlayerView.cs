...
namespace Plusar.Player
{
    ...
    public class PlayerView : MonoBehaviour
    {
        ...
        [SerializeField] private float m_playerFOV = 60.0f;
        ...
        [Range(0.0f, 0.5f)][SerializeField] private float m_lookSpeed = 0.1f;
        ...
        private void Update()
        {
            ...
            WeaponCamera.transform.position = CameraFollowTarget.transform.position;
            WeaponCamera.transform.rotation = CameraFollowTarget.transform.rotation;
        }
