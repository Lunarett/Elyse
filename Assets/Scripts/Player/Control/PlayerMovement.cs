...
public class PlayerMovement : MonoBehaviour
{
    ...
    [SerializeField]
    private GameObject m_cameraFollowTarget;
    ...
    [Header("Movement")] [SerializeField] private float m_movementSpeed = 10.0f;
    ...
    [Space(20.0f)] [Range(0.0f, 1.0f)] [SerializeField]
    private float m_crouchMultiplier = 0.5f;

    [Range(1.0f, 2.0f)] [SerializeField] private float m_sprintMultiplier = 2.0f;

    [Header("Stance")] [SerializeField] private float m_cameraHeightRatio = 0.9f;
    ...
    [Header("Audio")] [SerializeField] private float m_footstepSfxFrequency = 1.0f;
    ...
    {
        return CharacterVelocity.magnitude > 0.1f;
    }
}